...
export class B2bLogic extends Module {
     ...
     * @param params.dialog_id - the b2b_logic key, or the callid;from-tag;to-tag of the ongoing dialog
     * @param params.new_uri - the uri of the new destination
     * @param [params.flag] - used to specify that the callee must be bridged to the new destination. If not present the caller will be bridged. Possible values are 0 or 1.
     * @param [params.prov_media_uri] - the uri of a media server able to play provisional media starting from the beginning of the bridging scenario to the end of it. If not present, no other entity will be envolved in the bridging scenario
     */
