...
export default class Qrouting extends Module {
     ...
     * @param params.partition - (optional) a specific drouting partition to list statistics for
     * @param params.rule_id - (optional) a specific drouting rule database id to list statistics for
     * @param params.dst_name - (optional) a specific gateway or carrier name to list statistics for
     */
     ...
     * @param params.partition - (optional) drouting partition
