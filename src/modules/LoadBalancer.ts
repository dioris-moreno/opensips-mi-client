...
export class LoadBalancer extends Module {
     ...
     * @param params.destination_id - the ID (as per DB) of the destination.
     * @param [params.new_status] - If no new status is given, the function will return the current status. If a new status is given (0 - disable, 1 - enable), this status will be forced for the destination.
     */
