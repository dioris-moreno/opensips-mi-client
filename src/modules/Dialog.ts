...
export class Dialog extends Module {
     ...
     * @param [params.callid] - callid if a single dialog to be listed.
     * @param [params.from_tag] - (cannot be present without the callid parameter) - fromtag (as per initial request) of the dialog to be listed. entry
     ...
     * @param [params.extra_hdrs] - string containg the extra headers (full format) to be added to the BYE requests.
     */
     ...
     * @param [params.value] - string value to toughen the check;
     */
     ...
     * @param [params.value] - if the profile supports values terminate only the dialogs with the specified value
     */
     ...
     * @param [params.method] - the method used for the sequential message. Default value is .
     * @param [params.mode] - can be used to tune the behavior of the sequential message. Possible values for the are:
     * @param [params.body] - can be used to specify a body for the initial sequential message. Possible values for the parameter are:
     */
